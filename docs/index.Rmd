...
## Covid Report
Covid has spread rapidly across the US. The current total number of US cases is `r get_total_cases()`. And, the total number of US deaths is `r get_total_deaths()`. 
